...
const Hero = () => {
  return (
    <div className='w-full flex justify-center items-center mt-20 p-4'>
      ...
      <div className='text-white/60'>Layers has intergrated many technology solutions in across african contries collaborsting with more than 1000 developers to achive efficiency</div>
